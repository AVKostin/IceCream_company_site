Пошаговая инструкция по разворачиванию проекта для работы сборщика Parcel.
...
Через какое-то время живую страницу можно будет посмотреть по адресу указанному в отредактированном свойстве `homepage`, например
